...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 w-full border-b  backdrop-blur z-50 supports-[backdrop-filter]:bg-[#bfd7ed67] bg-[#bfd7ed]" >
      <nav className="container mx-auto px-4 h-16 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2">
          <Image
            ...
            width={200}
            height={60}
            className="h-11 w-auto object-contain pt-0.5"
          />
        </Link>
